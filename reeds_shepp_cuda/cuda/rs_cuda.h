...
// /**
//  * @brief Calculates the minimum length RS curve from a start to a goal given a radius of
//  curvature
...
// /**
//  * @brief Densifies an analytical curve (calculated by min_length_rs() method) and stores the
//  path
//  * @param ac The curve in its analytical form
//  * @param step The discretization resolution
//  * @param path The path to store (the size can be calculated using the length returned by
//  min_length_rs and step)
